module ApplicationHelper
  ...
  def link_to_remove_fields(name, f)
    f.hidden_field(:_destroy) + link_to_function(name, "remove_fields(this)", id: "remScnt", class: "btn-add btn-remove")
  end
  ...
  def link_to_add_fields(name, f, association)
    ...
    link_to_function(name, "add_fields(this, \"#{association}\", \"#{escape_javascript(fields)}\")", class: "btn-add",  id: "addScnt" )
  end
